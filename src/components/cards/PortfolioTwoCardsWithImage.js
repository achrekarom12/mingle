...
export default ({
  subheading = "It's a match!!",
  headingHtmlComponent = (
    <>
      Here are some <span tw="text-primary-500">amazing date-places.</span>
    </>
  ),
  description = "Here you can find beautiful places nearby to visit for your first date...!",
  ...
  const cards = [
    {
      ...
      company: "Versova Social",
      type: "Ad Campaign",
      title: "Versova Social.",
      durationText: "Cozzy place to chill",
      locationText: "Versova"
    },
    {
      imageSrc:
      ...
      company: "Starbucks",
      type: "Andheri",
      title: "Starbucks Andheri",
      durationText: "Starbucks",
      locationText: "Andheri"
    }
  ];
  return (
    <Container>
